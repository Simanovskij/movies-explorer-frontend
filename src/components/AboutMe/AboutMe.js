      ...
      <div className='about-me__content'>
        <div className='about-me__bio'>
          ...
          <p className='about-me__description'>
            ...
            <a href='https://mggu-sh.ru/ru'>МГГУ им. М. А. Шолохова</a>, а затем с 2010-го года
            занимался эквайрингом в{' '}
            <a href='https://www.zenit.ru/' className='about-me__link'>
              Банк Зенит.
            </a>{' '}
            Счастливо женат, есть совместный кот. Люблю бегать и коллекционировать ретро видеоигры.
          </p>
